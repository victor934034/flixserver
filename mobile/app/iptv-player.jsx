      ...
      <TouchableOpacity style={styles.videoWrap} activeOpacity={1} onPress={showControls}>
        <Video
          ...
          onPlaybackStatusUpdate={s => {
            setStatus(s);
            if (s.error) setError('Erro ao reproduzir canal');
          }}
          onError={() => setError('Não foi possível reproduzir este canal.')}
        />
        ...
        {!!error && (
          <View style={styles.overlay}>
            ...
            <TouchableOpacity
              ...
              onPress={() => { setError(null); videoRef.current?.replayAsync(); }}
            >
...
const styles = StyleSheet.create({
  ...
  retryBtn:      { marginTop: 8, backgroundColor: '#E50914', paddingHorizontal: 28, paddingVertical: 12, borderRadius: 8 },
  retryText:     { color: '#fff', fontWeight: '700' },

  controlsLayer: { ...StyleSheet.absoluteFillObject, justifyContent: 'space-between', backgroundColor: 'rgba(0,0,0,0.4)' },

  topBar:      { flexDirection: 'row', alignItems: 'center', padding: 16, paddingTop: 20 },
  ...
  playCircle:  { width: 72, height: 72, borderRadius: 36, backgroundColor: 'rgba(255,255,255,0.15)', borderWidth: 2, borderColor: 'rgba(255,255,255,0.4)', alignItems: 'center', justifyContent: 'center' },
